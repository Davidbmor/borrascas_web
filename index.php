<?php
// Punto de entrada principal → redirige a la landing page de selección de modelos
header('Location: landing.php', true, 301);
exit;

// ─── Código original del Modelo 1 conservado por si acaso ──────────
...
// Recoger mensaje de éxito si viene de procesar.php
$informeOk = null;
...
<head>
    ...
    <title>Informe de Daños por Borrasca – ACGranada</title>
...
<header class="site-header py-3 mb-4">
    <div class="container text-center">
        <img src="assets/img/Faeca.png" alt="ACGranada" class="site-logo">
    </div>
</header>
...
<main class="container pb-5">
    ...
    <form id="form-borrascas" method="POST" action="procesar.php"
        ...
        <!-- ═══════════════════════════════════════
             PASO 2 · TIPO DE INFORME
        ═══════════════════════════════════════ -->
        <div class="card shadow-sm mb-4">
            <div class="card-header section-header">
                <i class="bi bi-file-earmark-text-fill me-2"></i>Tipo de informe
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <select id="tipo_informe" name="tipo_informe"
                            ...
                            <option value="1">Modelo 1 – Daños en producción oleícola</option>
                            <option value="2" disabled>Modelo 2 – (Próximamente)</option>
                            <option value="3" disabled>Modelo 3 – (Próximamente)</option>
                        </select>
                    </div>
                </div>
            </div>
